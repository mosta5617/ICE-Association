...
class CKFinder extends Container implements HttpKernelInterface
{
    ...
    public function boot()
    {
        ...
        if ($config->get('sessionWriteClose') && session_status() === PHP_SESSION_ACTIVE) {
            session_write_close();
        }
    }
    ...
    /**
     * Returns resized image repository
     *
    ...
    /**
     * Returns the connector URL basing on current request
     *
     * @param bool|true $full if set to true the returned URL contains scheme and host
     *
     * @return string
     */
