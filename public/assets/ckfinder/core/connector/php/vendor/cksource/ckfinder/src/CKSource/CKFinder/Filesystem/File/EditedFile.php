...
class EditedFile extends ExistingFile
{
    ...
    /**
     * Checks double extensions in given file name
     *
     * @param null|string $fileName file name or null if current file name is checked
     *
     * @return bool true if extensions are allowed for current resource type
     */
    ...
    /**
     * Returns the new filename of the edited file
     *
     * @return null|string the new filename of the edited file
     */
    ...
    /**
     * Sets the flag if edited file is saved as new and does not exist yet in the filesystem
     *
    ...
    /**
     * Sets a new contents for the edited file
     *
    ...
    /**
     * Returns the new contents set for edited file
     *
     * @return string
     */
