...
class OperationManager
{
    ...
    /**
     * Checks if temporary directory for operation with given ID exists
     *
     * @param string $operationId
     *
     * @return bool true is directory exists - operation was started
     */
